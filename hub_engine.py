...
def print_banner():
    print("""
    ========================================================
    🏗️  INDUSTRIAL ENGINEERING MASTER HUB ENGINE v2.0
    ========================================================
    Sistem Mimarisi ve Karar Destek Ekosistemi
    "Mükemmel sistem yoktur, sadece optimize edilecek sistem vardır."
    ========================================================
    """)
...
def main_menu():
    while True:
        ...
        print(" [2] 🏭 Üretim Planlama & Stok Yönetimi")
        ...
        if choice == 'Q':
            ...
            run_tool('00_Operations_Research/simplex_solver_utils.py')
        elif choice == '1':
